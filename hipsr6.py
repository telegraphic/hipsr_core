...
class Spectrum_400_8192(tb.IsDescription):
    """ PyTables table descriptor: storage of spectral data
    For hipsr_400_8192 firmware: 400 MHz, 8192 channels.
    """
...
class Spectrum_200_16384(tb.IsDescription):
    """ PyTables table descriptor: storage of spectral data
...
class FirmwareConfig(tb.IsDescription):
    ...
    quant_yy_gain = tb.Int32Col(pos=2)  # Gain used in quantization - YY
    quant_xy_gain = tb.Int32Col(pos=3)  # Gain used in quantization - XY
...
def createSingleBeam(filename, path='./', flavor='hipsr_400_8192'):
    ...
    if flavor == 'hipsr_400_8192':
        h5.createTable(raw_data, 'beam_01', Spectrum_400_8192, 'Multibeam receiver beam 01')
    elif flavor == 'hipsr_200_16384':
        h5.createTable(raw_data, 'beam_01', Spectrum_200_16384, 'Multibeam receiver beam 01')
    elif flavor == 'hipsr_12_4096':
        h5.createTable(raw_data, 'beam_01', Spectrum_12_4096, 'Multibeam receiver beam 01')
...
def createMultiBeam(filename, path='./', num_beams=13, flavor='hipsr_400_8192'):
    ...
    for id in range(1, num_beams + 1):
        ...
        if flavor == 'hipsr_400_8192':
            h5.createTable(raw_data, 'beam_%02i' % id, Spectrum_400_8192, 'Multibeam receiver beam %02s' % id)
        elif flavor == 'hipsr_200_16384':
            h5.createTable(raw_data, 'beam_%02i' % id, Spectrum_200_16384, 'Multibeam receiver beam %02s' % id)
        elif flavor == 'hipsr_12_4096':
            h5.createTable(raw_data, 'beam_%02i' % id, Spectrum_12_4096, 'Multibeam receiver beam %02s' % id)
